...
If a Maintainer interprets your pull request or issue as not meeting this guidance, you will see a `reads as generated` label applied to your contribution along with the following comment:
...
- [The TBP Discourse forums](https://forum.thousandbrains.org/) are an excellent setting to discuss nascent ideas.
