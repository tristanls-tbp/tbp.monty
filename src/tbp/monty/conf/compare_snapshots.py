...
RUNS = [
    ...
    "base_infer_cows_large_compositional",
    "base_infer_cows_large_compositional_mujoco",
    "base_infer_cows_large_compositional_random_locs",
    "base_infer_cows_large_compositional_random_locs_mujoco",
    "base_infer_cows_large_monolithic",
    "base_infer_cows_large_monolithic_mujoco",
    "base_infer_cows_large_monolithic_random_locs",
    "base_infer_cows_large_monolithic_random_locs_mujoco",
    "base_infer_cows_small_compositional",
    "base_infer_cows_small_compositional_mujoco",
    "base_infer_cows_small_monolithic",
    "base_infer_cows_small_monolithic_mujoco",
    "randrot_noise_infer_cows_large_compositional",
    "randrot_noise_infer_cows_large_compositional_mujoco",
    "randrot_noise_infer_cows_large_monolithic",
    "randrot_noise_infer_cows_large_monolithic_mujoco",
    "randrot_noise_infer_cows_small_compositional",
    "randrot_noise_infer_cows_small_compositional_mujoco",
    "randrot_noise_infer_cows_small_monolithic",
    "randrot_noise_infer_cows_small_monolithic_mujoco",
    ...
    "supervised_pre_training_cows_3d_children",
    "supervised_pre_training_cows_3d_children_mujoco",
    "supervised_pre_training_cows_large_2d_children",
    "supervised_pre_training_cows_large_2d_children_mujoco",
    "supervised_pre_training_cows_large_compositional",
    "supervised_pre_training_cows_large_compositional_mujoco",
    "supervised_pre_training_cows_large_monolithic",
    "supervised_pre_training_cows_large_monolithic_mujoco",
    "supervised_pre_training_cows_small_2d_children",
    "supervised_pre_training_cows_small_2d_children_mujoco",
    "supervised_pre_training_cows_small_compositional",
    "supervised_pre_training_cows_small_compositional_mujoco",
    "supervised_pre_training_cows_small_monolithic",
    "supervised_pre_training_cows_small_monolithic_mujoco",
