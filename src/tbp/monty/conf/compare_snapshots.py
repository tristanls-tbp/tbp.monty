...
RUNS = [
    ...
    "supervised_pre_training_objects_with_stickers_3d_children",
    "supervised_pre_training_objects_with_stickers_2d_children",
    "supervised_pre_training_objects_with_stickers_comp_models",
    "supervised_pre_training_objects_with_stickers_monolithic_models",
